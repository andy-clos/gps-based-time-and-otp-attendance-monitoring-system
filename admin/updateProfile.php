...
UPDATE PROFILE PAGE - ADMIN (HTML)
    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class=" mb-4"><a href="leaveInfo.php" class="text-decoration-none px-3 py-2 d-block"><i
                        ...
                        Leave</a></li>
                <li class="active mb-4"><a href="profileInfo.php" class="text-decoration-none px-3 py-2 d-block"><i
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <form id="updateAdmin_form" class="form_class" method="POST" action="../php_functions/admin_update.php"  enctype="multipart/form-data" style="background-color: white;">
                    <div class="input-group-lg mb-3">
                    <?php 
                        $displayuser = "SELECT * FROM admin_info WHERE adminId = $adminId";
                        $user = mysqli_query($conn, $displayuser);
                        $row = mysqli_fetch_array($user, MYSQLI_ASSOC);
                    ?>
                        <!--call back all admin info for them to edit-->
                        <label for="formFile" class="form-label">Profile Picture</label>
                        <input type="file" name="profilePic" id="profilePic" class="form-control mb-4" accept="image/*">
                        <label class="mb-4">Name :</label>
                        <input type="text" name="name" id="name" class="form-control mb-4" value="<?php echo $row['adminName']; ?>"
                            required>
                        <label class="mb-4">IC Number :</label>
                        <input type="text" name="icNum" id="icNum" class="form-control mb-4"
                        value="<?php echo $row['adminICNum']; ?>" required>
                        <label class="mb-4">Phone Number :</label>
                        <input type="phone" name="phoneNum" id="phoneNum" class="form-control mb-4"
                        value="<?php echo $row['adminphoneNumber']; ?>" required>
                        ...
                        <input type="text" name="department" id="department" class="form-control mb-4"
                        value="<?php echo $row['adminDepartment']; ?>" required>
                        <div class="button">
                            <button type="submit" name="updateProfile" id="updateProfile"
                                class="submit_button btn btn-primary" form="updateAdmin_form">SAVE</button>
