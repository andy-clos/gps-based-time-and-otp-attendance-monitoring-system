...
UPDATE MANAGE USER PAGE - ADMIN (HTML)
...
<body onload="initClock()">
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <div class="container">
                <h2 class="fs-1 mb-5">UPDATE USER INFO</h2>
                <?php
                if(isset($_GET['id'])){
                    $usersId = $_GET['id'];
                ...
                <form id="updateUser_form" class="form_class" method="POST"
                    action="../php_functions/admin_update_user.php" style="background-color: white;">
                    <div class="input-group-lg mb-3">       <!--call back all user info for admin to edit-->

                        <label class="mb-4">User ID :</label>
                        <input type="text" name="usersId" id="usersId" class="form-control mb-4" value="<?php echo $row['usersId']; ?>" readonly>
                        <label class="mb-4">Name :</label>
                        <input type="text" name="name" id="name" class="form-control mb-4" value="<?php echo $row['usersName']; ?>" required>
                        <label class="mb-4">IC Number :</label>
                        <input type="text" name="icNum" id="icNum" class="form-control mb-4" value="<?php echo $row['usersICNum']; ?>" required>
                        ...
                        <input type="phone" name="phoneNum" id="phoneNum" class="form-control mb-4" value="<?php echo $row['usersPhoneNum']; ?>" required>
                        <label class="mb-4">Email :</label>
                        <input type="email" name="email" id="email" class="form-control mb-4" value="<?php echo $row['usersEmail']; ?>" required>
                        <label class="mb-4">Role :</label>
                        <input type="text" name="role" id="role" class="form-control mb-4" value="<?php echo $row['usersRole']; ?>" required>
                        <label class="mb-4">Department :</label>
                        <input type="text" name="department" id="department" class="form-control mb-4" value="<?php echo $row['usersDepartment']; ?>" required>
                        <div class="button">
                            <button type="submit" name="updateUser" id="updateUser" class="submit_button btn btn-primary" form="updateUser_form">SAVE</button>
                        </div>
                    </div>
                </form>
            </div>
