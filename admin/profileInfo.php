        ...
        <div class="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between  mb-3 mt-3">
                        ...
                        <div class="header"><a class="navbar-brand fs-2" href="dashboard.php" style="letter-spacing: 3px;"><span
                                    class="px-2 py-0 text-white">GLock Attendance</span></a>
                        </div>
                    </div>
                </div>
            </nav>
            <div class="container">
                ...
                <div id="profile" class="profile">
                    ...
                    <?php 
                        $displayPic = "SELECT profilePic FROM admin_info WHERE adminId = $adminId";
