...
REGISTER NEW USER PAGE - ADMIN (HTML)
...
<body onload="initClock()">
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <div class="container">
                <h2 class="fs-1 mb-5">REGISTER NEW USER</h2>

                <form id="addUser_form" class="form_class" method="POST" action="../php_functions/user_register.php" style="background-color: white;">
                    <div class="input-group-lg mb-3">
                        ...
                        <input type="text" name="icNum" id="icNum" class="form-control mb-4"
                            placeholder="Enter user's IC number" required>
                        <label class="mb-4">Date of Birth :</label>
                        <input type="date" name="dob" id="dob" class="form-control mb-4" required>
                        ...
                        <input type="password" name="passwd" id="passwd" class="form-control mb-4"
