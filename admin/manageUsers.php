    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class="active mb-4"><a href="manageUsers.php" class="text-decoration-none px-3 py-2 d-block"><i
        ...
        <div class="content">
            ...
            <div class="container">
                <h2 class="fs-1 mb-5" style="display: flex; justify-content: space-between;">MANAGE USERS<button
                        type="button" class="btn btn-secondary" onclick="window.location.href='addUsers.php'"><i
                            class="fal fa-plus-circle"></i> Add User</button>
                </h2>
                ...
                <div class="card shadow mb-5" style="border-color: black; border-width: 2px;">
                    ...
                    echo $displaytotalusers;?></li>
                        <li class="list-group-item text-center" style="background-color: rgb(202, 196, 186);">
                            <b>Registered Users List</b></li>
                        <table id="table" class="table table-hover" style="width: 100%; text-align:center; ">
                            <thead>
                                <tr>
                                    <th scope="col" style="width: 10%; text-align: center;">User ID</th>
                            ...
                            <tbody>
                                <?php 
                                          $displayuser = "SELECT * FROM users_info order by usersId DESC";
                                        ...
                                        <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal<?= $row['usersId'];?>"><i class="fal fa-user-alt"></i>
                                            PROFILE</button>

                                        <div class="modal fade" id="exampleModal<?= $row['usersId'];?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div>
                                                            <ul class="profileInfo">
                                                                <li class="infoDisplay"><b class="textInfo">NAME</b>: <?php echo $row['usersName'];?></li>
                                                                <li class="infoDisplay"><b class="textInfo">IC NUMBER</b>: <?php echo $row['usersICNum'];?></li>
                                                                <li class="infoDisplay"><b class="textInfo">DATE OF BIRTH</b>: <?php $date = strtotime($row['usersDOB']); echo date("d/m/Y", $date);?></li>
                                                                <li class="infoDisplay"><b class="textInfo">PHONE NUMBER</b>: <?php echo $row['usersPhoneNum'];?></li>
                                                                <li class="infoDisplay"><b class="textInfo">EMAIL</b>: <?php echo $row['usersEmail'];?></li>
                                                                <li class="infoDisplay"><b class="textInfo">ROLE</b>: <?php echo $row['usersRole'];?></li>
                                                                <li class="infoDisplay"><b class="textInfo">DEPARTMENT</b>: <?php echo $row['usersDepartment'];?></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <button type="button" class="btn btn-info"
                                            onclick="window.location.href='updateManageUser.php?id=<?php echo $row['usersId']; ?>'"><i
                                                class="fal fa-edit"></i>
                                            UPDATE</button>
                                        <a href="../php_functions/delete_user.php?id=<?php echo $row['usersId']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?') "><i class="fal fa-trash"></i>
                                            DELETE
                                    </td>
                                <?php echo "</tr>"; ?>
                                            <?php
