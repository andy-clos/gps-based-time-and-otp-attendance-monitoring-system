...
REGISTER NEW ADMIN PAGE - ADMIN (HTML)
...
<body onload="initClock()">
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <div class="container">
                <h2 class="fs-1 mb-5">REGISTER NEW ADMIN</h2>

                <form id="addAdmin_form" class="form_class" method="POST" action="../php_functions/admin_register.php" style="background-color: white;">
                    <div class="input-group-lg mb-3">
                        ...
                        <input type="text" name="department" id="department" class="form-control mb-4"
                            placeholder="Enter admin's department" required>
                        <div class="button">
                            <button type="submit" name="registerAdmin" id="registerAdmin"
                                class="submit_button btn btn-primary" form="addAdmin_form">REGISTER</button>
                        </div>
                        <?php 
                        if(isset($_GET["error"])){
