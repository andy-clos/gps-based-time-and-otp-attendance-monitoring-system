...
<html lang="en">
    ...
    <body>
        <main>
            <form id="forgotPwd_form" class="fPassform_class" action="../php_functions/admin_update_forgot_pwd.php" method="POST">
                <div class="form_div">
                <?php
                    ...
                    "SELECT * FROM admin_info WHERE token='$token' and adminEmail='$email';"
                    );
                    ...
                    <div class="button">
                        <button id="changePass" class="submit_button" type="submit" name="new-password" form="forgotPwd_form">Change</button>
