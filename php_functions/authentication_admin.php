...
include('conn.php');
    ...
    $password = $_POST['password'];  
        ...
        $sql = "select * from admin_info where adminEmail = '$email'";  
        ...
        if($checkPwd === true){  
            ...
            $otp = rand(100000,999999);
                    ...
                    $mail->Body="<p>Dear admin, </p> <h3>Your verify OTP code is $otp <br></h3>
                    <br><br>
                    <p>With regards,</p>
            ...
            header("location: ../admin/loginpage.php?error=wronglogin");
            exit();
        }     