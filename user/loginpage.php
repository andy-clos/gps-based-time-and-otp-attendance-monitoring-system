...
<html lang="en">
    ...
    <body onload="initClock()">
        <main>
            ...
            <form id="login_form" class="form_class" action="../php_functions/authentication.php" method="POST">
                ...
                <div class="form_div">
                    ...
                    <div class="button">
                        <button id="login" class="submit_button" type="submit" form="login_form">Login</button>
                ...
                <script>
                    function ForgotPassword_Alert(){
                        alert("Any problem with login, please contact your system administrator.")
                    }
                </script>
            </form> 
        </main>
